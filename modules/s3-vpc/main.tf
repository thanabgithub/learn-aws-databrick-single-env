    ...
    content {
      ...
      dynamic "apply_server_side_encryption_by_default" {
        ...
        content {
          ...
          kms_master_key_id = try(apply_server_side_encryption_by_default.value.kms_master_key_id, 
            apply_server_side_encryption_by_default.value.sse_algorithm == "aws:kms" ? var.kms_key_id : null)
        }
      }
    }
  }
